-- ============================================================================
-- Dados pessoais Fase 1: adiciona data de nascimento e profissão ao cliente,
-- e atualiza create_client_full para persistir os novos campos.
--
-- Migration não destrutiva: não remove idade existente nem altera dados atuais.
-- ============================================================================
