-- ============================================================================
-- Participação societária Fase 1: percentual de participação.
--
-- Migration não destrutiva: mantém renda_mensal como total mensal usado nos
-- cálculos atuais e guarda percentual da participação societária.
-- ============================================================================
...
begin
  ...
  insert into clients (
    ...
    tem_participacao_societaria, valor_participacao, percentual_participacao,
  ...
  values (
    ...
    (payload ->> 'percentual_participacao')::numeric,
