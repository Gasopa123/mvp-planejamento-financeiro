-- ============================================================================
-- Financeiro Fase 3: detalhes do patrimônio investido.
--
-- Migration não destrutiva: mantém renda_mensal como total mensal usado nos
-- cálculos atuais e guarda local aplicado e investimento no exterior.
-- ============================================================================

alter table clients
  add column if not exists local_aplicado text,
  add column if not exists tem_investimento_exterior boolean not null default false,
  add column if not exists valor_investimento_exterior numeric(14, 2);
