-- ============================================================================
-- Financeiro Fase 2: despesas temporárias.
--
-- Migration não destrutiva: mantém renda_mensal como total mensal usado nos
-- cálculos atuais e guarda despesas temporárias em despesa_mensal_base/despesas_temporarias.
-- ============================================================================

alter table clients
  add column if not exists despesa_mensal_base  numeric(14, 2),
  add column if not exists despesas_temporarias jsonb not null default '[]'::jsonb;
...
begin
  ...
  insert into clients (
    ...
    salario_liquido, outras_rendas, renda_mensal, despesa_mensal_base, despesas_temporarias, despesa_mensal, patrimonio_investido,
